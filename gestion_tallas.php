...
<head>
    ...
    <title>Gestión de Contenido / presentaciones</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="panel panel-info">
                            <div class="panel-heading"> Gestión de contenido/presentaciones</div>
                           ...
                           <hr>
                                     ...
                                     <div class="row">
                                        ...
                                        <label for="input1">Ingrese tipo de contenido/presentación</label>
                                           <input type="text" class="form-control" id="talla" name="talla" required><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                        </div>
                                     </div>
                                     <!-- fin de bloque-->
         ...
         function guardar_talla(){
          ...
          var talla = document.getElementById("talla").value;
           ...
           if(talla){
            ...
            $.ajax({
            type: "POST",
            url: "procesos/savetipotalla.php",
            contentType: false,
