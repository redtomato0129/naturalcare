...
<body>
  ...
  <tbody class="caracteristicas">
    <tr>
      ...
      <td class="text-center plan-bronce">1x</td>
      <td class="text-center plan-plata">1.5 Veces</td>
      <td class="text-center plan-oro">2x</td>
    </tr>
    <tr>
    ...
    <span class="accion"><a href="#">Editar</a>  | <a href="#">Eliminar</a> </span>
     <div class="bt-switch"><input type="checkbox" checked  data-on-color="primary" data-size="mini" /></div>
      ...
      <td class="text-center plan-plata">150 Puntos</td>
      <td class="text-center plan-oro">200 Puntos</td>
    </tr>
    <tr>
      <th scope="row" style="height:4em">Envío Gratis
      <span class="accion"><a href="#">Editar</a>  | <a href="#">Eliminar</a> </span>
      <div class="bt-switch"><input type="checkbox" checked  data-on-color="primary" data-size="mini" /></div>
      </th>
      <td class="text-center plan-bronce">$49.99+</td>
      <td class="text-center plan-plata"><img src="../images/isotipo.svg"> </td>
      <td class="text-center plan-oro"><img src="../images/isotipo.svg"> </td>
    </tr>
    <tr>
      <th scope="row" style="height:4em">Acceso anticipado a las ventas
      <span class="accion"><a href="#">Editar</a>  | <a href="#">Eliminar</a> </span>
      <div class="bt-switch"><input type="checkbox" checked  data-on-color="primary" data-size="mini" /></div>
      </th>
    ...
    <tr>
      <th scope="row" style="height:4em">Sorteo de Mercancía
      <span class="accion"><a href="#">Editar</a>  | <a href="#">Eliminar</a> </span>
      <div class="bt-switch"><input type="checkbox" checked  data-on-color="primary" data-size="mini" /></div>
      </th>
      <td class="text-center plan-bronce">-</td>
