                                     ...
                                     <div class="row">
                                        ...
                                        <label for="input1">Nombre del producto</label>
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="codigo" value="<?php echo $fpro['codigo'] ?>" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group m-b-40">
                                                <label for="input3">Puntos</label>
                                            <input type="text" class="form-control" id="points" value="<?php echo $fpro['points_val'] ?>" required><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                   <label>Aplica Envio </label> 
                                                    <div class="input-group">
                                                        ...
                                                        <option value="1" <?php if($fpoint['envio'] == '1'){ ?> selected <?php } ?>>SI</option>
                                ...
                                <div class="radio-list">
                                  ...
                                  <?php } }  ?>
                                      ...
                                      <div class="row">
                                       ...
                                       <input type="button" class="btn btn-success model_img" onclick="guardar_producto()" id="completar" value="Editar Producto" />
                                        </div>
                         ...
                         if(subcategoria){
                                if(tallas){
                                  var paqueteDeDatos = new FormData();
                                    ...
                                    paqueteDeDatos.append('points', points); // nuevo
                                   /* paqueteDeDatos.append('plan', plan); */// nuevo
