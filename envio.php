                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                               ...
                               <form>
                                     ...
                                     <div class="row">
                                      ...
                                      <label for="input6">Elige la provincia -  Crea o elimina provincias desde <a href="crear_provincia.php">aquí</a></label>
                                   ...
                                   <!-- inicio de bloque-->
                                     <div class="row">
                                        <div class="col-md-9" id="ciu">
                                            <div class="form-group m-b-40">
                                            <label for="input6">Elige la ciudad - Crea o elimina ciudades desde <a href="crear_ciudad.php">aquí</a></label>
                  ...
                  if(ciudad != '0'){
                    ...
                    contentType: false,
                                ...
                                cache: false, 
                                    ...
                                    if(msg.trim() == "00::00")
                                  {
                                    swal("Alto!","Ya existe valor de envio para esta ciudad" , "error");
