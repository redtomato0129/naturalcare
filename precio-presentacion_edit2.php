...
if($_SESSION['LOGUEO'] == '1')
{
    ...
    if(is_numeric($_GET['id']) && $_GET['id'] > 0)
    {
      ...
      $spropredit = "SELECT a.*,b.nombre as producto,c.descripcion as categoria,
      b.id as idproducto,
      c.id as idcategoria FROM productos_presentacion as a
      LEFT JOIN productos as b ON (a.producto=b.id)
      LEFT JOIN subcategorias as c ON (b.subcategoria = c.id)
      WHERE a.estado='1' and a.id=".$_GET['id'];
      $rpropredit = mysql_query($spropredit);
      $fpropredit = mysql_fetch_array($rpropredit);
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="panel panel-info">
                            <div class="panel-heading">Editar valores a tipo de medidas/presentación</div>
                                     ...
                                     <div class="row">
                                      ...
                                      <label for="input6">Sub-Categoría</label>
                                            <select class="form-control p-0" id="categoria" onchange="buscar_pro()" required>
                                              <option value="<?php echo $fpropredit['idcategoria']; ?>" selected="selected"><?php echo $fpropredit['categoria']; ?></option>
                                              <?php 
                                     ...
                                     <div class="row">
                                        <div class="col-md-9" id="pro">
                                            ...
                                            <select class="form-control p-0" id="producto" onchange="buscar_presentacion()" required>
                                                <option value="<?php echo $fpropredit['idproducto']; ?>"><?php echo $fpropredit['producto']; ?></option>
                                                </select><span class="highlight"></span> <span class="bar"></span>
                                     ...
                                     <div class="row">
                                      ...
                                      <label for="input6">Presentación</label>
                                            <select class="form-control p-0" id="presentacion" required>
                                                <option value="<?php echo $fpropredit['presentacion']; ?>"><?php echo $fpropredit['presentacion']; ?></option>
                                   ...
                                   <!-- inicio de bloque-->
                                     <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <input type="text" class="form-control" id="valor" value="<?php echo $fpropredit['precio']; ?>" placeholder="solo números" onKeyPress="return soloNumeros(event)" required="">
                                        </div>
                                        </div>
                                     </div>
                                     <!-- fin de bloque-->
                                       ...
                                       <input type="button" class="btn btn-success model_img" onclick="guardar_precio()" id="completar" value="ACTUALIZAR PRECIO" />
                                        </div>
                     ...
                     <div class="col-md-5">
                            ...
                            <div class="panel-heading">Editar Asociar Puntos a tipo de medidas/presentación</div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                               <form>
                                     ...
                                     <div class="row">
                                      ...
                                      <label for="input6">Categoría</label>
                                            <select class="form-control p-0" id="input6" required>
                                                ...
                                                <option>Línea facial</option>
                                                <option>Línea corporal</option>
                                                <option>Línea capilar</option>
                                                <option>etc</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                   ...
                                   <!-- inicio de bloque-->
                                     <div class="row">
                                      ...
                                      <label for="input6">Productos</label>
                                            <select class="form-control p-0" id="input6" required>
                                                <option>seleccione</option>
                                                <option>Shampoo de Romero</option>
                                                <option>Shampoo Gardenia</option>
                                                <option>Shampoo de manzanilla</option>
                                            </select><span class="highlight"></span> <span class="bar"></span>
                                   ...
                                   <!-- inicio de bloque-->
                                     <div class="row">
                                        <div class="col-md-9">
                                            <div class="form-group m-b-40">
                                            <label for="input6">Indique los puntos</label>
                                            <input type="text" class="form-control" id="input1" placeholder="solo números" required="">
                                        </div>
                                        </div>
                                     </div>
                                     <!-- fin de bloque-->
                                        ...
                                        <hr>
                                        <div class="form-actions m-t-40">
                                            <button type="submit" class="btn btn-primary" id="sa-image"> <i class="fa fa-check"></i>Mensaje cuando faltó algo</button>
