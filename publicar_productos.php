                            ...
                            <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="cant-puntos" value="<?php echo $fpro['points_val'] ?>" required><span class="highlight"></span> <span class="bar"></span>
                                        </div>
                                        </div>
                                </div>
                                 <!-- fin de bloque-->
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <p class="text-muted m-t-5">Foto principal</p>
                                          ...
                                          <input type="file" id="foto_cuatro" name="archivo4" value="" data-parsley-id="0521"></div>
                    </div>
                   <!-- fin de bloque-->
...
<!-- color picker -->
    ...
    function asignarpuntos()
    {
            var resultado = "";
            // var losPuntosid = as;
            var losPuntos = $("#pointgroupid"+resultado).data("pointss");
            $("#cant-puntos").val(losPuntos);
    }
    ...
    swal({   
        ...
        contentType: false,
         ...
         // var recompensas = $("#recompensas").val();
          var recompensas ="";
          var puntosRecompensas = $("#cant-puntos").val();
          var frecuencia = "";
          var puntos =  $('input:radio[name=radio]:checked').val();
          var points = document.getElementById("cant-puntos").value;
          var plan = "1";
