...
if($validador == 0)
{
	...
	$sql = "INSERT INTO natuser VALUES ('','".$_POST['nombres']."','".$_POST['apellidos']."','".$_POST['celular']."','".$_POST['telefono']."','EC','".$_POST['provincia']."','".$_POST['ciudad']."','".$_POST['direccion']."','".$_POST['referencia']."','".$_POST['ruc']."','".$_POST['razon']."','".$_POST['direccionf']."','".$_POST['telefonof']."','".$_POST['email']."','".md5($_POST['contrasena'])."','1',now())";
	$res=mysql_query($sql);
