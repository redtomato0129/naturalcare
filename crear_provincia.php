                                   ...
                                   <!-- inicio de bloque-->
                                     <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <label for="input6">Ingrese Provincia</label>
                                            <input type="text" class="form-control" name="provincia" id="provincia" placeholder="Ingrese Provincia"  required="">
                                        </div>
                                        </div>
                                     </div>
                                     <!-- fin de bloque-->
                                       ...
                                       <input type="button" class="btn btn-success model_img" onclick="guardar_envio()" id="completar" value="GUARDAR PROVINCIA" />
                                        </div>
                                    ...
                                    <tbody>
                                      <?php while($fenvio = mysql_fetch_array($renvio)){ ?>
                                        <tr>
                                           ...
                                           <td> <a href="javascript:void(0)" class="text-inverse" title="Borrar" data-toggle="tooltip" onclick="eliminar(<?php echo $fenvio['id'] ?>,'<?php echo $fenvio['provincia'] ?>')" ><i class="ti-trash"></i></a>
                                            </td>
                                        </tr>
                                      <?php } ?>
              ...
              function guardar_envio()
            {
              ...
              if(provincia != '')
              {
                ...
                var paqueteDeDatos = new FormData();
                    ...
                    $.ajax({
                    type: "POST",
                    url: "procesos/saveprovincia.php",
                    contentType: false,
                                data: paqueteDeDatos, // Al atributo data se le asigna el objeto FormData.
                                processData: false,
                                cache: false, 
                                    ...
                                    if(msg.trim() == "00::00")
                                  {
                                    swal("Alto!","Ya existe esta provincia" , "error");
...
function eliminar(id,pro){
        ...
        swal({   
            ...
            closeOnConfirm: false 
                    ...
                    paqueteDeDatos.append('provincia', pro);
              
            $.ajax({
            type: "POST",
            url: "procesos/deleteenvioprovincia.php",
            contentType: false,
                        data: paqueteDeDatos, // Al atributo data se le asigna el objeto FormData.
                        processData: false,
                        cache: false, 
