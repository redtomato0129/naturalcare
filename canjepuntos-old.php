                         ...
                         <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">  
                         	 <h3 class="box-title">Configurar descuentos</h3>
                   			 <hr>
                                 ...
                                 <input type="text" name="ptodolares" id="ptodolares" class="form-group" value="" />   
                                    
                               
                                    <label>VALOR EN PUNTOS</label>
                                   
                                 <input type="text" name="pto" id="pto" class="form-group" value="" />   

                                  <label>MINIMO</label>
                                   
                                 <input type="number" name="minimo" id="minimo" class="form-group" value="" />   
