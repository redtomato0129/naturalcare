                ...
                <div class="row">
                    ...
                    <div class="col-md-4" >
                       ...
                       <!-- <div class="sidebar-block open">
                            <div class="sidebar-block_title"><span>Aplicar cupón de descuento</span>
                                <div class="toggle-arrow"></div>
                            </div>
                            <div class="sidebar-block_content"><label class="text-uppercase">introduce el código:</label>
                                <div class="form-flex">
                                    <div class="form-group"><input type="text" id="codigo" value="<?php echo $fcupon['codigo'] ?>" class="form-control" <?php if($fcupon['codigo'] != ""){ ?> disabled="disabled" <?php } ?> ></div>
                        ...
                        <div class="sidebar-block collapsed">
                            <div class="sidebar-block_title"><span>Calcular envío</span>
                                <div class="toggle-arrow"></div>
                            </div>
                            <div class="sidebar-block_content"><label class="text-uppercase">Provincia:</label>
                                <div class="form-group select-wrapper"><select class="form-control" id="provincia" onchange="buscarciudad(this.value)">
                                    ...
                                    <div class="form-group select-wrapper" id="ciu">
