                            ...
                            <table class="table table-hover">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="derecha">$<?php echo $iva=number_format(((($subtotal/1.15)-$descuento)*0.15),2) ?></td>
                                </tr>
                                <?php
                                if($subtotal > 120)
                                  {   
                                ...
                                ?>
                                <?php if($_SESSION['invitado']== "") {  }else{  $envio = 0; $fusuario['ciudad']="(Por Calcular)"; } ?>
                                
                                
                                <tr>
                                  <th scope="row">Envío a <?php echo $fusuario['ciudad'] ?> (+)</th>
                                  <td class="derecha"><div id="envio"><?php echo number_format($envio,2); ?></div></td>
                                </tr>
