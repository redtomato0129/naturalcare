                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="step1">
                                    <div class="tab-pane-inside">
                                        ...
                                        <div class="row mt-2 fondeado">
                                          <div class="row my-1 mx-2"><p>Fecha de Cumpleaños</p></div>
                                        
                                        <div class="col-sm-4">
                                           <div class="form-group">
                                            <input required="required" id="cano"  placeholder="Año" class="form-control cano" data-date-format="yyyy-mm-dd">
                                           </div>
                                        </div>
                                       </div>
...
$('.cano').datepicker({
    ...
    {   
        ...
        //valor cumpleaños lo comentado ya no existen esos campos
        // var mes = document.getElementById("cmes").value;
        // var dia = document.getElementById("cdia").value;
        var cumple = document.getElementById("cano").value;
        // cumple = ano+" - "+mes+" - "+dia  ;
         ...
         if(nombres)
         {
            ...
            {
                 swal("Alto!","Complete sus campos vacíos" , "error");
                    $('#completar').attr('onClick', 'crear_cuenta();');
                    $('#cano').focus();
            }
         }else
