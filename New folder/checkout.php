            ...
            <div class="container">
                ...
                <form  id="comprar">
                    <div class="row">
                                    ...
                                    <?php } ?>
                                         <div class="row mt-2">
                                            <div class="col-sm-6"><label class="text-uppercase">* Email:</label>
                                             ...
                                             <?php if (!$_SESSION['puntoscanjeados'] > 0  ){  ?>

                                            <?php if ( $pointsUser['status_beneficio'] != "2" ){  ?>
                                            <div class="col-sm-6">
                                ...
                                <?php } ?>
                                    ...
                                    <?php } ?>
                                      ...
                                      <div class="row mt-2">
                                        ...
                                        <p style="font-style: italic; font-size:12px; line-height: 11px; ">- Los envíos se llevan a cabo a través de la empresa de mensajería: SERVIENTREGA. Este es el único medio de envío de mercancía aceptado por nuestra empresa.</p> 
                                        
                                        <p style="font-style: italic; font-size:12px; line-height: 11px; ">- LA DIRECCIÓN DE ENTREGA DEBE ESTAR CORRECTA DESDE EL PRIMER MOMENTO DEL PEDIDO, si los datos son incorrectos debe tener en cuenta las demoras adicionales que esto ocasiona.</p> 
                                        
                                        <p style="font-style: italic; font-size:12px; line-height: 11px; ">- EL CLIENTE SE RESPONSABILIZA POR NUEVOS COSTOS DE ENVÍO SI LA DIRECCIÓN ES ERRÓNEA O INCOMPLETA, Y SI NO SE ENCUENTRA UNA PERSONA EN LA DIRECCIÓN PROPORCIONADA.</p> 
                                        
                                        <p style="font-style: italic; font-size:12px; line-height: 11px; ">- Aunque el tiempo promedio de entrega de los pedidos es de 3 días hábiles (exceptuando Galápagos), la entrega depende de factores y empresas ajenas a nosotros, por lo que no podemos confirmar hora exacta de entrega. Es por eso que le recomendamos dejar una dirección en donde SIEMPRE se encuentre una persona mayor de edad que pueda recibir el paquete (portería, oficina, etc.). Si por alguna razón no puede garantizar la presencia de una persona en el lugar de entrega, le recomendamos solicitar que su pedido sea dejado en un punto de atención del Courier y de la que tenga certeza que existe una oficina operativa en su localidad.</p> 
                                        
                                        
                                        <p style="font-style: italic; font-size:12px; line-height: 11px; ">- Si desea retirar el paquete en alguna agencia del Courier, debe detallarlo de la siguiente manera: DIRECCIÓN: "Retiro en agencia Servientrega Quito Oficina Cumbaya, Eloy Alfaro OE1-34 y Av. María Angélica Idrovo".</p> 
                                       ...
                                       <!-- paso 4-->
                                        ...
                                        <div class="clearfix">
                                            <input id="formcheckoutRadio6" value="Payphone" name="pago" type="radio" class="radio" onclick="buscarpago(0)"> <label for="formcheckoutRadio6">Payphone -  Para compras superiores a $300 o Pagos diferidos.</label>
                                        </div>
                        ...
                        <?php $descuento = $descuento1+$descuento2+$descuento3; ?>
                        <div class="col-md-4 mt-2 mt-md-5" id="resumen">
                            ...
                            <table class="table table-hover">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="derecha"><?php echo number_format($puntoscanjeados,0) ?></td>
                                </tr>
                            ...
                            <div class="card-total-sm">
                                <div class="float-right">total <span class="card-total-price">$ <?php echo  $ttot= number_format((($subtotal/1.15))-($descuento)+(((($subtotal/1.15)-$descuento)*0.15))+($envio/1.15)+(number_format((($envio/1.15)*0.15),2)),2) ?></span></div>
