            ...
            <div class="container">
                <div class="row justify-content-around">
                        ...
                        <div id="loginForm">
                            ...
                            <div class="form-wrapper">
                                ...
                                <form action="#">
                                    ...
                                    <p class="text-uppercase"><a href="#" class="js-toggle-forms">Olvidaste tu contraseña?</a></p>
                    ...
                    <div class="col-sm-6 col-md-4 mt-3 mt-sm-0">
                        ...
                        <div class="form-wrapper">
                            <p>Al crear una cuenta en nuestra tienda, podrás pasar por el proceso de pago más rápido, rastrear tus pedidos y más.</p><a href="crear-cuenta.php" class="btn">Crear cuenta</a>
                        </div>
                        <br><br>
                        
                         <h2 class="text-center">INVITADO</h2>
                        <div class="form-wrapper" onclick="invitado()">
                            <p>Esta vez compraré sin registrarme, en otra ocasión crearé mi cuenta.</p><a onclick="invitado();" class="btn">Comprar como invitado</a>
                        </div>
