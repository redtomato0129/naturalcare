...
<head>
   ...
   <meta name="description" content="productos para el cuidado personal, cuidado capilar elaborados a base de estractos de origen natural">
    ...
    <title>Mi dirección - Natural Care ec</title>
            ...
            <div class="container">
                <div class="row">
                   ...
                   <div class="col-md-9 aside">
                        <h2>Mi dirección para recibir pedidos</h2>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h3>Dirección 1 (predeterminada)</h3>
                                        <p><?php echo $fusuario['direccion'] ?><br>
                                        <b>Provincia:</b><?php echo $fusuario['provincia'] ?><br>
                                        <b>Ciudad:</b><?php echo $fusuario['ciudad'] ?><br>
                                        <b>referencia:</b><?php echo $fusuario['referencia'] ?><br>
                                        </p>
                                        <div class="mt-2 clearfix"><a href="#" class="link-icn js-show-form" data-form="#updateAddress"><i class="icon-pencil"></i>Editar</a></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6"><label class="text-uppercase">Dirección:</label>
                                        <div class="form-group"><input type="text" id="direccion" value="<?php echo $fusuario['direccion'] ?>" class="form-control"></div>
                                    </div>
                                    <div class="col-sm-6"><label class="text-uppercase">Referencia de como llegar:</label>
                                        <div class="form-group"><input type="text" id="referencia" value="<?php echo $fusuario['referencia'] ?>" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="mt-2"><button type="reset" class="btn btn--alt js-close-form" data-form="#updateAddress">Cancelar</button> <button type="button" onclick="actualizartres()" class="btn ml-1">Guardar</button></div>
                            </div>
                        </div>
                    </div>
        ...
        if(provincia)
                {
                   ...
                   {
                     swal("Alto!","Ingresa una direccion" , "error");
                     $('#completar').attr('onClick', 'login();');
                    }
                    }else
                   {
