                                ...
                                <div class="sttabs tabs-style-bar">
                                               ...
                                               <h3>Publicar Nueva Categoría</h3>
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <label for="input1">Nombre de la Categoría</label>
                                                               <input type="text" class="form-control" id="categoria" required><span class="highlight"></span> <span class="bar"></span>
                                                            </div>
                                                            </div>
                                                         </div>
                                                         <!-- fin de bloque-->
                                    ...
                                    <div class="row">
                                               ...
                                               <h3>Publicar Nueva Sub-Categoría</h3>
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <label for="input1">Nombre de la Sub-Categoría</label>
                                                               <input type="text" class="form-control" id="subcategoria" required><span class="highlight"></span> <span class="bar"></span>
                                                            </div>
                                                            </div>
                                                         </div>
                                                         <!-- fin de bloque-->
                                        ...
                                        <div class="col-md-7 col-lg-7 col-sm-6">
                                                     ...
                                                     <div class="white-box">
                                                         <h3 class="box-title">SubCategorías Publicadas</h3>
                                                         <hr>
                                                <div class="table-responsive">
                                                   
<ul id="sortable"  style="width: 100%;background: #fff;">
<?php
$sql = "SELECT a.*,b.descripcion as categoria FROM subcategorias as a
LEFT JOIN categorias as b ON (a.categoria=b.id)
WHERE a.estado='1' order by a.orden asc";
$resul= mysql_query($sql);

while($fila = mysql_fetch_array($resul)){
?>
  <li class="ui-state-default" id="city_<?php echo $fila['id'] ?>" style="cursor:pointer;box-shadow: 2px 2px 5px #999;padding-bottom: 35px;background: #fff;font-size: 15px;"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo $fila['categoria'] ?> :: <?php echo $fila['descripcion'] ?>
   <div class="btn-group m-r-10 right"><!--
<button aria-expanded="false" data-toggle="dropdown" class="btn btn-default btn-outline dropdown-toggle waves-effect waves-light" type="button"> <i class="fa fa-edit m-r-5"></i> <span class="caret"></span></button>
...
<a href="categorias_subcategorias_edit.php?idcate=<?php echo $fila['id'] ?>" class="btn btn-success btn-circle" id="" ><i class="fa fa-edit" style="color: #fff;"></i> </a>
<button type="button" class="btn btn-warning btn-circle" id="" onclick="eliminar_subcategoria(<?php echo $fila['id'] ?>)"><i class="fa fa-times"></i> </button>
</div>
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    $(document).ready(function(){
        $('#sortable').sortable({
            ...
            cursor: 'move',
            update: function() {
                var order = $('#sortable').sortable("serialize")+'&action=orderState';
                $.post("procesos/ordenar_subcategoria.php", order, function(theResponse){
